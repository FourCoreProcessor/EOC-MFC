...
def detect_face(image_path):
    ...
    face_image_resized = resize(face_image_rgb, (128, 64), anti_aliasing=True)
...
def test_image(image_path, cnn_model, svm, scaler, device):
    ...
    if image is None:
        logger.info("Skipping emotion prediction: No face detected.")
        return None
...
if __name__ == "__main__":
    ...
    # Test image
    test_image_path = r"C:\Users\devis\Documents\academic\s2\eocmfc\test40.png"
